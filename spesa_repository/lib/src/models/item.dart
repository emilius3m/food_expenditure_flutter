...
class Item {
  ...
  Item(this.product, {this.complete = false, String note = '', String id,String imageurl,String quantity, String type})
      :   this.note = note ?? '',
  ...
  Item copyWith({bool complete, String id, String note, String product,  String quantity, String imageurl, String type }) {
    return Item(
